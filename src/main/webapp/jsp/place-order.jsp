            ...
            <form role="form">
              ...
              <div class="col-sm-4">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
		              <p style="color: red;">*Our service is available from 9AM to 9PM, Your parcel service order will be delivered next one hour after order AND Tiffin service will be working as your order time(Weekly/Monthly)</p>
		            </div>
                </div>
              </div>
