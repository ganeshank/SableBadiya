...
<body>
	...
	<nav class="navbar navbar-inverse" style="background-color: #344763;">
...
<!-- <div class="container">
	<div class="row">
		<div class="col-sm-12 text-center" style="color:red;">
			You will get these items in next 1 hour after order.
		</div>
	</div>
	 		...
	 		<c:forEach items="${goods}" var="good" varStatus="status">
				 <c:choose>
				 	<c:when test="${good.inStock}">
				 		<div class="col-sm-5 col-md-5 col-lg-5 text-center fruitsbox">
				 			<c:choose>
				          ...
				          <!-- <a href="javascript:void(0);" class="thumbnail img-href"> -->
				            <img src="${good.webpath}" class="goods-img" style="width:440px;height:220px;">
				            <!-- </a> -->
				            <%-- <c:choose>
