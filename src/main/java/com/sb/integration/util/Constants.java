...
public class Constants {
	...
	public final static Integer CLOSED_CART_STATUS_ID = 9;
	
	
	public final static Integer SELLER_CART_ITEM_STATUS_WAIT = 3;
	
	public final static Integer ORDER_SOURCE_TYPE_WEB = 1;
	public final static Integer ORDER_SOURCE_TYPE_ANDROID = 2;
	public final static Integer ORDER_SOURCE_TYPE_IOS = 3;
