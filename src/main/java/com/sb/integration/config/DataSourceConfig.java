...
import com.sb.integration.service.impl.ConfigServiceImpl;
...
public class DataSourceConfig implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        try {
	        ...
	        List<GoodsVo> goodsList = goodsService.getAllGoods(ds.getConnection());
	        String goodsJson = new Gson().toJson(goodsList);
